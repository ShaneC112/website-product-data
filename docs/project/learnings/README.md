...
Learning entries record a concrete observation, evidence, scope, and the rule it supports. Canonical detail pages and their area indexes are the source of truth; repository-root `LEARNINGS.md` files are redirects only.
