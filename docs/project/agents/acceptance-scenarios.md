...
| `planner-architecture-gap-documentation` | Project Planner; Architecture | Missing stable current-state architecture discovered during planning may be corrected in canonical architecture docs; future or unapproved design remains in the plan. | `workspace-customizations/.github/agents/project-planner.agent.md`; [architecture](../architecture/README.md) | Static verified |
