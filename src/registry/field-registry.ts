...
export const fieldRegistry: FieldRegistryEntry[] = [
  ...
  createEntry('Carpet', 'brandName', 'Manufacturer or brand name for the product range.', 'optional', 'text', { category: 'identity', promptHint: 'When m2crm brandNameHint is supplied, use it as brandName. Otherwise, identify the manufacturer or brand from vendor-page evidence and omit it only when no brand can be determined.' }),
  ...
  createEntry('Carpet', 'pileWeight', 'Explicit pile weight measurement when present in carpet specifications.', 'recommended', 'measurement', { exampleValue: '1700 g/m²', promptHint: 'Look for values in g/m², g/m2, or oz in specification tables. May be labelled pile weight g/m², pile weight g/m2, or a weight such as 40oz/50oz.' }),
  ...
  createEntry('Carpet', 'togRating', 'TOG rating when explicitly stated in carpet specifications.', 'optional', 'text', { exampleValue: '1.7 tog' }),
  createEntry('Carpet', 'suitability', 'Suitability classification when explicitly stated, such as General Domestic or Heavy Domestic.', 'optional', 'text', { exampleValue: 'Heavy Domestic' }),
  createEntry('Carpet', 'warranty', 'Warranty text when explicitly stated, including domestic or commercial warranty wording.', 'optional', 'text', { exampleValue: '15 year wear warranty' }),
  ...
  createEntry('Carpet Tile', 'brandName', 'Manufacturer or brand name for the product range.', 'optional', 'text', { category: 'identity', promptHint: 'When m2crm brandNameHint is supplied, use it as brandName. Otherwise, identify the manufacturer or brand from vendor-page evidence and omit it only when no brand can be determined.' }),
  ...
  createEntry('Laminate', 'brandName', 'Manufacturer or brand name for the product range.', 'optional', 'text', { category: 'identity', promptHint: 'When m2crm brandNameHint is supplied, use it as brandName. Otherwise, identify the manufacturer or brand from vendor-page evidence and omit it only when no brand can be determined.' }),
  ...
  createEntry('Laminate', 'lockingSystem', 'Named locking or click system when explicitly stated.', 'optional', 'text', { exampleValue: 'Uniclic' }),
  createEntry('Laminate', 'bevel', 'Plank bevel construction when explicitly stated.', 'optional', 'text'),
  createEntry('Laminate', 'warranty', 'Warranty text when explicitly stated.', 'optional', 'text'),
  createEntry('Laminate', 'fireRating', 'Fire classification when explicitly stated.', 'optional', 'text', { exampleValue: 'Bfl-s1' }),
  createEntry('Laminate', 'slipResistance', 'Slip resistance classification when explicitly stated.', 'optional', 'text'),
  createEntry('Laminate', 'thermalResistance', 'Thermal resistance when explicitly stated.', 'optional', 'text'),
  createEntry('Laminate', 'impactSoundReduction', 'Impact sound reduction when explicitly stated.', 'optional', 'text'),
  ...
  createEntry('Vinyl', 'brandName', 'Manufacturer or brand name for the product range.', 'optional', 'text', { category: 'identity', promptHint: 'When m2crm brandNameHint is supplied, use it as brandName. Otherwise, identify the manufacturer or brand from vendor-page evidence and omit it only when no brand can be determined.' }),
  ...
  createEntry('Vinyl', 'wearLayer', 'Explicit wear-layer thickness for vinyl products.', 'recommended', 'measurement', { exampleValue: '0.55 mm' }),
  createEntry('Vinyl', 'installationMethod', 'Installation method when explicitly stated, such as click, glue-down, or loose lay.', 'recommended', 'text'),
  createEntry('Vinyl', 'lockingSystem', 'Named locking or click system when explicitly stated.', 'optional', 'text'),
  createEntry('Vinyl', 'warranty', 'Warranty text when explicitly stated.', 'optional', 'text'),
  createEntry('Vinyl', 'fireRating', 'Fire classification when explicitly stated.', 'optional', 'text', { exampleValue: 'Bfl-s1' }),
  createEntry('Vinyl', 'slipResistance', 'Slip resistance classification when explicitly stated.', 'optional', 'text'),
  createEntry('Vinyl', 'thermalResistance', 'Thermal resistance when explicitly stated.', 'optional', 'text'),
  ...
  createEntry('Engineered Wood', 'dimensions', 'Board dimensions when explicitly present.', 'required', 'text', { exampleValue: '1820 x 190 mm', promptHint: 'Return the full board dimensions including both length and width.' }),
  createEntry('Engineered Wood', 'construction', 'Board construction when explicitly stated, such as multi-layer engineered wood.', 'recommended', 'text'),
  createEntry('Engineered Wood', 'topLayerThickness', 'Wear or top-layer thickness when explicitly stated.', 'recommended', 'measurement', { exampleValue: '3 mm' }),
  ...
  createEntry('Engineered Wood', 'slipResistance', 'Slip resistance classification when explicitly stated.', 'optional', 'text'),
  createEntry('Engineered Wood', 'thermalResistance', 'Thermal resistance when explicitly stated.', 'optional', 'text'),
  ...
  createEntry('Engineered Wood', 'variantCaptureCount', 'Count of captured vendor variants when evidenced by the capture manifest.', 'optional', 'text', { category: 'meta', publishable: false }),
  ...
  createEntry('Unknown', 'brandName', 'Manufacturer or brand name for the product range.', 'optional', 'text', { category: 'identity', promptHint: 'When m2crm brandNameHint is supplied, use it as brandName. Otherwise, identify the manufacturer or brand from vendor-page evidence and omit it only when no brand can be determined.' }),
